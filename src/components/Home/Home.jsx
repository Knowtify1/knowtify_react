...
const FeatureItem = ({ image }) => (
  <div className="p-2 rounded-md mb-2 mt-2">
    {image}
  </div>
);
...
const Feature = ({ description, title }) => (
  <div className="p-8 rounded-md mb-2 mt-30">
    ...
    <p className="text-gray-600" style={{ color: '#666666', letterSpacing: '1px' }}>{description}</p>
  </div>
);

const DeveloperItem = ({ image }) => (
  <div>
    {image}
  </div>
);
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        <Button
          type="link"
          icon={<CloseCircleOutlined style={{ fontSize: '1.5rem', color: 'white' }} />}
          style={{
            position: 'relative',
            top: '0x',
            right: '-400px',
      ...
      <main className="container mx-30 mt-30 px-40 flex flex-col items-center">
          ...
          <div className=" flex items-center">
            <div>
              <h1 className="text-5xl font-bold text-gray-800">
                ...
                <br></br>
              <p><CheckOutlined className="text-green-500 mr-2" /> Electronic Medical Records</p>
              <p><CheckOutlined className="text-green-500 mr-2" /> Appointment scheduling</p>
              <p><CheckOutlined className="text-green-500 mr-2" /> Reminder System</p>
            </div>
            <div className="p-2">
              <FeatureItem
                image={<img src={doc2} alt="Image1" className="w-85 max-h-90" />}
              />
            </div>
          </div>
        </section>
        ...
        <section className="mb-2 mx-auto ">
          <h2 className="text-2xl font-bold text-gray-800 mb-2 items-start">Key Features:</h2>

          <div>
            <div className="bg-white p-2 rounded-md flex items-center">
              <FeatureItem
                image={<img src={emr} alt="Image1" className="w-30 h-50 object-cover mb-2 rounded-md" />}
              />
              <Feature
            ...
            <div className="bg-white p-2 rounded-md  flex items-center">
              ...
              />
              <FeatureItem
                image={<img src={cal} alt="Image1" className="w-30 h-50 object-cover mb-2 rounded-md" />}
              />
              
            </div>
            <div className="bg-white p-2 rounded-md  flex items-center">
              <FeatureItem
                image={<img src={sms} alt="Image1" className="w-30 h-50 object-cover mb-2 rounded-md" />}
              />
              <Feature
          ...
          <section className="mb-2 mx-auto ">
          <h2 className="text-2xl font-bold text-gray-800 mb-2 items-start">About Us:</h2>
          <div className="bg-white p-0 rounded-md flex items-center ">
            ...
            <div className="bg-white p-2 rounded-md  flex items-center">
              <DeveloperItem
                image={<img src={andre} alt="Image1" className="w-20 h-50 object-cover mb-2 rounded-md" />}
              />
              <Developer
